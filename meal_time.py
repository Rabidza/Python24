...
lunch_notes = "Like the regular one, but with tsatziki sauce"
dinner_special = "Buffalo steak"
dinner_notes = "Top loin with thot sauce and blue cheese.  NOT BUFFALO MEAT."

meal_time  = raw_input('Which mealtime do you want? [breakfast, lunch, dinner] ' ).lower().strip()
